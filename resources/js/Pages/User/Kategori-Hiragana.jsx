...
export default function KategoriHiragana() {
    ...
    const handleClick = async (item) => {
        try {
            const pembelajaranId = `belajar-hiragana-${item}`;
                                                            ...
                                                            {!category.unlocked ? (
                                                                ...
                                                                >
                                                                    {category.status == "selesai"   ? (
                                                                        ...
                                                                        <TrendingUpIcon className="h-5 w-5 text-primary cursor-pointer" onClick={() =>
                                                                            category.unlocked &&
                                                                            setActiveCategory(
                                                                                category.id === activeCategory
                                                                                    ? null
