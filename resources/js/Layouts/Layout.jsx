          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              ...
              <Link href="/" className="flex items-center space-x-3 group">
                ...
                <span className="text-2xl font-bold text-foreground">KotoBee</span>
              </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <span className="text-2xl font-bold text-card-foreground">KotoBee</span>
                    <p className="text-muted-foreground text-sm">Platform Pembelajaran Terdepan</p>
                  </div>
                </div>
              ...
              {/* Contact Info */}
              <div>
                <h3 className="text-lg font-semibold text-card-foreground mb-4">Hubungi Kami</h3>
                <ul className="space-y-3">
